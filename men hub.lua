...
local Window = Library.CreateLib("Prison life breaker v1.0.1a", "Sentinel")
local Tab = Window:NewTab("Player")

local Section = Tab:NewSection("Walkspeed")


Section:NewSlider("Walk speed", "Changes Walk Speed", 500, 16, function(s) -- 500 (MaxValue) | 0 (MinValue)
    game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = s
end)

Section:NewSlider("Jump power", "Changes Jump Power", 500, 50, function(s) -- 500 (MaxValue) | 0 (MinValue)
    game.Players.LocalPlayer.Character.Humanoid.JumpPower = s
end)

-- Misc
    local Main = Window:NewTab("Misc")
    local MainSection = Main:NewSection("Gun Things")
    ...
    local MainSection = Main:NewSection("Kill Aura (Fixed :c)")
...
Section:NewKeybind("Ui toggle", "Select key for close and open Prison life breaker ui", Enum.KeyCode.Z, function()
	Library:ToggleUI()
end)

local Tab = Window:NewTab("Credits")
local Section = Tab:NewSection("Credits:men,yoruldumanne,proyumoye123")
Section:NewLabel("Discord: men#0327")
local Tab = Window:NewTab("Working Games")
